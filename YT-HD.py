...
try:
    ...
    # Si estás en Windows debes especificar la ruta de descarga o comentar las líneas 42,43,44,45.
    # Si has comentado las líneas, el archivo se descargará en la misma carpeta donde se encuentre YT-HD.py
